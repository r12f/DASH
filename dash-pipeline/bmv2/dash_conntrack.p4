                ...
                inout metadata_t meta)
{
  ...
  /* Invalidate entry based on TCP flags */
          ...
          meta.conntrack_data.original_overlay_sip = original_overlay_sip;
          meta.conntrack_data.original_overlay_dip = original_overlay_dip;
  }
          ...
          if (hdr.tcp.flags == 0x2 /* SYN */) {
            if (meta.pkt_meta.direction == dash_direction_t.OUTBOUND) {
               ...
               add_entry("conntrackIn_allow",
                         {meta.conntrack_data.original_overlay_sip, meta.conntrack_data.original_overlay_dip},
